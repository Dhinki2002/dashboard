  ...
  return (
    <div className="sign-up-as-login">
      ...
      <div className="frame-parent-login">
        <div className="cantileverlogoblack-2-parent-login">
          <CantileverLogo
        ...
        <div className="frame-group-login">
          <div className="sign-up-parent-login">
            <div className="sign-up-login">Sign up :</div>
            <div className="frame-container-login">
              <button className={selected === 0 ? "frame-parent52-login" : "frame-button-login"} onClick={onIndividualButtonClick}>
                ...
                <svg className="material-symbolsperson-outlin-icon-login" width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className={selected === 0 ? "as-an-individual-login" : "as-an-institution-login"}>As an Individual</div>
                </div>
                <img
              ...
              <button className={selected === 1 ? "frame-parent52-login" : "frame-button-login"} onClick={onInstitutionButtonClick}>
...
<path d="M16.0003 1.14172L29.3337 8.54972V12.0004H2.66699V8.54972L16.0003 1.14172ZM6.74699 9.33372H25.2537L16.0003 4.19239L6.74699 9.33372ZM9.33366 14.6671V25.3337H6.66699V14.6671H9.33366ZM17.3337 14.6671V25.3337H14.667V14.6671H17.3337ZM25.3337 14.6671V25.3337H22.667V14.6671H25.3337ZM2.66699 28.0004H29.3337V30.6671H2.66699V28.0004Z" fill={selected===1 ? "white": "#2a2a2a"}/>
                  ...
                  <div className={selected === 1 ? "as-an-individual-login" : "as-an-institution-login"}>As an Institution</div>
                </div>
          ...
          <div className="frame-parent1-login">
            <button className="frame-wrapper-login" onClick={onFrameButton1Click}>
              <div className="continue-as-individual-wrapper-login">
                <div className="continue-as-individual-login">
                  {selected === 0
            ...
            <Link className="already-have-an-container-login" to="/login">
